/*
                            ...
                            Written: 26/9-21
                            The code takes inputs and puts them in an array, then it sorts it using insertion sorting,this code sorts in decending order.
...
public class del7 {
    ...
    public static void inverse(int[] array){                        //inverses the array by taking each element and multiplying by -1 this makes the largest value the smalest and vice versa
    ...
    public static void main(String[] args){
        ...
        for (int i = 0; i<ARRAY_LENGHT;i++){
            elements[i] = (inputInt())*-1;          //takes the input and inverses them this will make the list sort in reversed order
        }
        for (int i = 0; i<ARRAY_LENGHT;i++){
            System.out.print(elements[i] + ", ");
        }
        System.out.println();
        insertionSort(elements);                    //sort
        inverse(elements);                          //inverses the array back so that the elements have the same value as when they where inputted
        for (int i = 0; i<ARRAY_LENGHT;i++){
            System.out.print(elements[i] + ", ");
        }
    }
